...
<div className="max-w-sm p-6 mb-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    We are your #1 partners in event planning. Virtual, hybrid, & in-person corporate events! Design, Planning, 
    Logistical Coordination of Exhibits, Sponsors, & Vendors & More
    </p>
